...
**Scroll propio de la tabla, con los encabezados de columna fijos (1 de septiembre de 2026):** pediste que la tabla de Evaluación Financiera tuviera su propio scroll (en vez de hacer scroll en toda la página) y que el encabezado de columnas se quedara fijo arriba mientras bajas, para siempre saber a qué columna corresponde cada dato. Le puse su propio recuadro con scroll a la tabla (con un límite de alto en vez de estirarse sin fin), y cada fila de encabezado de columna (Concepto/Año 1/Año 2/Año 3/Total, Métrica/Resultado/etc.) se queda pegada arriba del recuadro mientras avanzas — en cuanto entras a la siguiente sección, su propio encabezado toma el lugar del anterior, así que siempre ves el de la parte que estás mirando. El resto de la pantalla (menú, título del panel, botones de Guardar/Excel/PDF) no se mueve. Probé, con un navegador automatizado, que al bajar dentro del recuadro el encabezado correcto se quede fijo arriba y el resto de la página no se mueva, sin errores de consola.
