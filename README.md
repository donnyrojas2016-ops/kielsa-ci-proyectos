...
3. Sube el `index.html` de este paquete a GitHub. En cuanto cargue, entra como Administrador, haz clic en el ícono de personas del encabezado, y ahí le asignas "Editor" o "Solo lectura" a quien quieras limitar. Los demás quedan como Administrador por defecto.
